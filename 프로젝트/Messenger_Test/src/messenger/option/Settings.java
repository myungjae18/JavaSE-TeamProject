...
public class Settings extends JFrame {
   ...
   public void previewFont(String font) {
      ...
      mainFrame.lb_state.setFont(new Font(setFont, Font.PLAIN, 12));
      ...
      for (int i = 0; i < chat.chatArray.length; i++) {
         chat.chatArray[i].la_name.setFont(new Font(setFont, Font.BOLD, 18));
         chat.chatArray[i].la_content.setFont(new Font(setFont, Font.PLAIN, 14));
         chat.chatArray[i].la_time.setFont(new Font(setFont, Font.PLAIN, 14));
      }
   ...
   public void setCircle(int i) {
      ...
      p_circle.addMouseListener(new MouseAdapter() {
         public void mouseClicked(MouseEvent e) {
            ...
            for (int a = 0; a < chat.chatArray.length; a++) {
               chat.chatArray[a].addMouseListener(new MouseAdapter() {
   ...
   public void returnFont() {
      ...
      mainFrame.lb_state.setFont(new Font(f, Font.PLAIN, 12));
      ...
      for (int i = 0; i < chat.chatArray.length; i++) {
         chat.chatArray[i].la_name.setFont(new Font(f, Font.BOLD, 18));
         chat.chatArray[i].la_content.setFont(new Font(f, Font.PLAIN, 14));
         chat.chatArray[i].la_time.setFont(new Font(f, Font.PLAIN, 14));
      }
   }
